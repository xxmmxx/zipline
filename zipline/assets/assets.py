...
def create_finder_from_index(index, as_of_date):
    """
    ...
    An AssetFinder build for the input index.
    """
    ...
    for identifier in index:
        ...
        if isinstance(identifier, Asset):
            ...
            finder.insert_metadata(identifier=sid, **metadata)
        else:
            finder.insert_metadata(identifier)
    ...
    missing = []
    for identifier in index:
        finder._lookup_generic_scalar(identifier, as_of_date,
                                      matches, missing)
